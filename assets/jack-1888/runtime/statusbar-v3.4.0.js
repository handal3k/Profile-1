...
#jack1888-statusbar .sb-map-tool{display:none;background:radial-gradient(circle at 35% 30%,#516857,#26352c 58%,#131b16);border-color:#b89459;color:#f0d79d}
...
@media(max-width:760px){
  ...
  #jack1888-statusbar .sb-map-tool{display:grid}
  #jack1888-statusbar.sb-collapsed{width:min(218px,calc(100vw - 16px))}
  #jack1888-statusbar.sb-collapsed .sb-mark{max-width:120px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
`;
  ...
  function ensureStatusbar(bannerManager) {
    ...
    const mapButton = createElement(doc, 'button', 'sb-tool sb-map-tool', '⌖');
    mapButton.type = 'button';
    mapButton.title = '打开 Whitechapel 调查台';
    mapButton.setAttribute('aria-label', '打开 Whitechapel 调查台');
    mapButton.setAttribute('aria-controls', 'jack1888-map-dialog');
    const collapse = createElement(doc, 'button', 'sb-tool', '−');
    collapse.type = 'button';
    collapse.title = '折叠状态栏';
    collapse.setAttribute('aria-label', '折叠状态栏');
    toolbar.append(mapButton, collapse);
    ...
    panel.__jack1888 = { date, location, locationScene, sceneName, stage, truth, metrics, note, mapButton, rows: legacyRows, legacyNote: createElement(doc, 'span') };
    return panel;
  }
  ...
  (async () => {
    ...
    panel.__jack1888.mapButton.addEventListener('click', () => map.dialog.__jack1888.open());
